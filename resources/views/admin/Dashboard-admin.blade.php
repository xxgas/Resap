...
@section('content')
    <main class="max-w-7xl mx-auto p-6">
        ...
        {{-- Header --}}
        <div class="bg-blue-600 rounded-2xl p-8 mb-8 text-white shadow-lg shadow-blue-100 flex flex-col md:flex-row items-center gap-4">
            <div>
            ...
            <a href="{{ route('admin.view-user') }}" class="bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 transition-all active:scale-95 shadow-md">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
